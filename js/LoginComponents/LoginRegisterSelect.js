...
var LoginRegisterSelect = React.createClass({
	...
	render () {
		var selected = this.props.selected == "Login" ?
			<LoginForm email={this.props.email} password={this.props.password}/> :
			<RegisterForm username={this.props.username} email={this.props.email} password={this.props.password}/>;
