...
var SubmissionComponent = React.createClass({
  ...
  render () {
    ...
    var reviewButton = submission.underReview == true ? <div className={btn.reviewRed}>Under Review</div> : <div className={btn.reviewBlue} onClick={this._handleClick}>Review</div>;
